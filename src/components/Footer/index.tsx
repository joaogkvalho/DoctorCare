...
export function Footer(){
    return(
        <Flex w="100%" h="300px" bg="green.700" align="center" justify="center">
            <Flex w="80%" align="center" justify="space-between">
                <Flex direction="column">
                    <Flex mb="2">
                        <Text fontSize="4xl" color="gray.50">Doctor</Text>
                        <Text fontSize="4xl" color="gray.50" fontWeight="bold">Care</Text>
                    </Flex>

                    <Text color="gray.50" mb="2">&copy;2022 - DoctorCare.</Text>
